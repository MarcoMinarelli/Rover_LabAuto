...
\end{equation}
Per la scelta dei campi attrattivi e repulsivi, alcune scelte solitamente usate \cite{libroRobotica} sono il campo attrattivo si è scelto un potenziale Huber-like: 
\begin{equation}
  \begin{cases}
...
Per il campo repulsivo dell'ostacolo $i$-esimo, invece si è scelto
\begin{equation}
  \begin{cases}
...
distanza tra il robot e l'ostacolo e infine con $ \delta_0 $ la sogli asopra la quale l'ostacolo non esercita nessuna influenza sul robot.
...
\begin{figure} [H]
    \centering
    \includegraphics[width=0.5\linewidth]{img/LOS.PNG}
...
\end{itemize}
Dalla letteratura definiamo una SS del tipo $S(t)=s=0$, con s variabile di sliding. La variabile di sliding è una combinazione lineare degli stati errore del sistema ed è definita come:
\begin{equation}
